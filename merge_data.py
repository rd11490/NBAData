...
for season in seasons:
    ...
    cut = pd.read_csv('data/synergy_Cut_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'POSS_PCT', 'PPP', 'PERCENTILE']]
    transition = pd.read_csv('data/synergy_Transition_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]

    iso = pd.read_csv('data/synergy_Isolation_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]
    ball_handler = pd.read_csv('data/synergy_PRBallHandler_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]

    rollman = pd.read_csv('data/synergy_PRRollman_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]
    postup = pd.read_csv('data/synergy_Postup_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]

    spotup = pd.read_csv('data/synergy_Spotup_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]
    handoff = pd.read_csv('data/synergy_Handoff_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]

    offscreen = pd.read_csv('data/synergy_OffScreen_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]
    putbacks = pd.read_csv('data/synergy_OffRebound_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]

    misc = pd.read_csv('data/synergy_Misc_{}_Regular Season.csv'.format(season))[['PLAYER_ID', 'TEAM_ID', 'PERCENTILE', 'PPP', 'POSS_PCT']]
